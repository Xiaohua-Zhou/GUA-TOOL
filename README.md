...
一个功能齐全的实用工具箱集合，包含倒计时、随机数生成、骰子投掷器、单位换算器、日期计算器、二维码生成器、决策轮盘、数字转换器、计算器、颜色转换器、Markdown 编辑器、CSS 渐变生成器和像素圆生成器。
...
### 10. 颜色转换器
支持十六进制色号、HEX、RGB、HSL 之间的颜色格式转换，提供颜色预览。
- 适用于设计、前端开发、颜色搭配等场景
...
### 13. 像素圆生成器
生成像素风格的圆形图案，支持自定义水平和竖直尺寸，可选择边线或填充模式，提供实时预览和像素统计，支持 PNG 和 SVG 格式下载。
- 适用于像素艺术、游戏开发、UI 设计等场景
...
│   │   └── pixel-circle-generator.tsx # 像素圆生成器
│   │
│   ├── hooks/                # React Hooks
