...
export default function CSSGradientGenerator() {
  ...
  return (
    <Card className="w-full max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 shadow-2xl bg-gradient-to-br from-background to-muted/20">
      {/* 标题 */}
      <div className="text-center mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-muted-foreground">创建漂亮的渐变背景</p>
      </div>
