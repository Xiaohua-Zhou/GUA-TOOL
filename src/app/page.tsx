          ...
          <div className="flex flex-col items-center gap-3 sm:gap-4">
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 bg-gradient-to-r from-gray-700 to-gray-900 dark:from-gray-600 dark:to-gray-800 text-white rounded-lg sm:rounded-xl hover:from-gray-600 hover:to-gray-800 dark:hover:from-gray-500 dark:hover:to-gray-700 transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-lg sm:rounded-xl hover:from-pink-400 hover:to-rose-400 transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
              >
                ...
                <span className="text-sm sm:text-base font-medium">Bilibili</span>
              </a>
            </div>
          </div>
        </footer>
